...
sfw.icon_list("icons_a3", 0x91, [
  ...
  ICON.Inftry, 0, 0xe7, 0x99,
  ICON.Mech,   0, 0x8b, 0xa9
])
...
sfw.icon_list("icons_a5", 0x91, [
  ...
  ICON.Inftry, 0, 0xca, 0x58,
  ICON.Mech,   0, 0x87, 0x69
])

# Page A6
sfw.icon_list("icons_a6", 0x91, [
  ICON.APC,    0, 0x7d, 0x57,
  ICON.Lander, 0, 0xc7, 0x57,
  ICON.TCoptr, 0, 0x85, 0x69,
  ICON.Inftry, 0, 0xb2, 0x78,
  ICON.TCoptr, 0, 0x7d, 0x8a,
  ICON.TCoptr, 0, 0x7d, 0xa9
])

# Page A7
sfw.icon_list("icons_a7", 0x91, [
  ICON.Inftry, 0, 0xba, 0x38,
  ICON.Mech,   0, 0x6d, 0x48,
