...
sfw.icon_list("icons_a3", 0x91, [
  ICON.HQ,     0, 0xa3, 0x57,
  ICON.ButtnA, 0, 0xe9, 0x5a,
  ICON.Wrench, 0, 0xc7, 0x69,
  ICON.CursrG, 0, 0xc6, 0x69,
  ICON.Gold,   0, 0x68, 0x7a,
  ICON.Inftry, 0, 0xe7, 0x98,
  ICON.Mech,   0, 0x8b, 0xa8
])

# Page A4
sfw.icon_list("icons_a4", 0x91, [
  ICON.Inftry, 0, 0x82, 0x38,
  ICON.Mech,   0, 0x85, 0x48,
...
sfw.icon_list("icons_a5", 0x91, [
  ICON.ButtnA, 0, 0x7b, 0x3a,
  ICON.Inftry, 0, 0xca, 0x57,
  ICON.Mech,   0, 0x89, 0x67
])

# Page A6
sfw.icon_list("icons_a6", 0x91, [
  ICON.APC,    0, 0x7d, 0x57,
  ICON.Lander, 0, 0xc7, 0x58,
  ICON.TCoptr, 0, 0x7c, 0x68,
  ICON.Inftry, 0, 0xb3, 0x77,
  ICON.TCoptr, 0, 0x78, 0x88,
  ICON.TCoptr, 0, 0x7f, 0xa8
])

# Page A7
sfw.icon_list("icons_a7", 0x91, [
  ICON.Inftry, 0, 0xb6, 0x38,
  ICON.Mech,   0, 0x7f, 0x48,
  ICON.Inftry, 0, 0x77, 0x98,
  ICON.Mech,   0, 0xcc, 0x98,
  ICON.HP,     0, 0x6c, 0xa8
])

# Page A8
sfw.icon_list("icons_a8", 0x91, [
  ICON.ButtnX, 0, 0x4c, 0x6a,
  ICON.Artly,  0, 0xaa, 0x88
])
...
sfw.icon_list("icons_a9", 0x91, [
  ...
  ICON.CursrR, 0, 0xe3, 0x68,
  ICON.ButtnR, 0, 0x46, 0x88,
  ICON.CursrR, 0, 0xe3, 0x88,
  ICON.HQ,     0, 0x9c, 0x77,
...
sfw.icon_list("icons_a11", 0x91, [
  ICON.Sub,    0, 0x4e, 0x79,
  ICON.Port,   0, 0x9e, 0xb8
])
...
sfw.icon_list("icons_a15", 0x91, [
  ICON.Vision, 0, 0xcb, 0x8a,
  ICON.Recon,  0, 0xc9, 0x99,
  ICON.Cruisr, 0, 0x82, 0xa9
])
...
sfw.icon_list("icons_b3", 0x91, [
  ICON.Base,   0, 0xe7, 0x38,
  ICON.Airprt, 0, 0xa5, 0x48,
  ICON.Port,   0, 0xdc, 0x48,
  ICON.Depot,  0, 0x77, 0x58
])

# Page B4
sfw.icon_list("icons_b4", 0x91, [
  ICON.Select, 0, 0xda, 0x48,
  ICON.HP,     0, 0xda, 0x57,
  ICON.Fuel,   0, 0x81, 0x67,
  ICON.Rounds, 0, 0xc5, 0x67,
  ICON.DPad,   0, 0xe9, 0x78,
  ICON.ButtnA, 0, 0x7d, 0x8a
])

# Page B5
sfw.icon_list("icons_b5", 0x91, [
  ICON.HP,     0, 0xd4, 0x57,
  ICON.Fuel,   0, 0x75, 0x67,
  ICON.Rounds, 0, 0x8b, 0x67,
  ICON.HQ,     0, 0x4b, 0x88,
...
sfw.icon_list("icons_b6", 0x91, [
  ...
  ICON.HP,     0, 0x47, 0x88,
  ICON.Fuel,   0, 0x47, 0x98,
  ICON.Gold,   0, 0x5a, 0x9a,
  ICON.Rounds, 0, 0x47, 0xa8,
  ICON.ButtnX, 0, 0x47, 0xba
])
...
sfw.icon_list("icons_c1", 0x91, [
  ICON.WRange, 0, 0x86, 0x68,
  ICON.WRange, 0, 0x75, 0x8a,
  ICON.ButtnX, 0, 0x78, 0xa8,
  ICON.WRange, 0, 0x76, 0xb8
])
...
sfw.icon_list("icons_c7", 0x91, [
  ...
  ICON.Fuel,   0, 0x99, 0xa8
])

# Page C8
sfw.icon_list("icons_c8", 0x91, [
  ICON.APC,    0, 0x49, 0x77,
  ICON.Inftry, 0, 0xb7, 0x77,
  ICON.Mech,   0, 0xd9, 0x77,
  ICON.TCoptr, 0, 0x48, 0x88,
  ICON.Inftry, 0, 0xb7, 0x88,
  ICON.Mech,   0, 0xd9, 0x88,
...
sfw.icon_list("icons_c9", 0x91, [
  ...
  ICON.Lander, 0, 0x49, 0x99,
  ICON.Shoal,  0, 0xd6, 0x98,
  ICON.Port,   0, 0xe6, 0x98,
  ICON.Cruisr, 0, 0x49, 0xa9,
  ICON.Cruisr, 0, 0xd2, 0xa9,
  ICON.Train,  0, 0x49, 0xb8,
  ICON.Depot,  0, 0x96, 0xb8
])
