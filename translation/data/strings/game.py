...
# NEW GAME / SAVE DATA MANAGEMENT
  ...
  0x87F4DA: { "b":0x87F4DA, "e":0x87F4F2, "l":24, "en":"⏫20_| Selecionar jogo salvo",     "ja":"　　再戦データのせんたく"  },
  0x87E6CA: { "b":0x87E6CA, "e":0x87E6E2, "l":24, "en":"⏫20__Compartimento de dados",      "ja":"　　記録エリアのせんたく"  },
  0x87EB31: { "b":0x87EB31, "e":0x87EB47, "l":22, "en":"⏫30_Compartimento de destino", "ja":"　　複写さきのせんたく"  },
  0x87EB15: { "b":0x87EB15, "e":0x87EB2F, "l":26, "en":"⏫40__|Copiar jogo salvo",       "ja":"　複写するデータのせんたく"  },
  0x87EB49: { "b":0x87EB49, "e":0x87EB5D, "l":20, "en":"⏫50_ |Dados do jogo copiado!_",    "ja":"　　　複写できました"  },
  0x87ECA3: { "b":0x87ECA3, "e":0x87ECBD, "l":26, "en":"⏫20__Apagar jogo salvo",      "ja":"　削除するデータのせんたく"  },
  0x87ECBF: { "b":0x87ECBF, "e":0x87ECD3, "l":20, "en":"⏫30_ |Dados do jogo apagado!_",   "ja":"　　　削除できました"  },
  ...
  0x87F2C1: { "b":0x87F2C1, "e":0x87F2D9, "l":24, "en":"Nenhum dado do jogo",                 "ja":"休戦データなし　　　　　"  },
  0x87F2DB: { "b":0x87F2DB, "e":0x87F2DF, "l":4,  "en":"|dias",                        "ja":"日　"  },
  0x87F2E1: { "b":0x87F2E1, "e":0x87F2E9, "l":8,  "en":"_⏮2 finalizado",                   "ja":"　終了　"  },

  0x87E8C3: { "b":0x87E8C3, "e":0x87E8DB, "l":24, "en":"⏫C0⏮1|Substituir o jogo salvo?",  "ja":"この記録を削除しますか？"  },
  0x87E843: { "b":0x87E843, "e":0x87E849, "l":6,  "en":"⏫CD_OK",                          "ja":"　はい"  },
  0x87E850: { "b":0x87E850, "e":0x87E858, "l":8,  "en":"⏫D0_Cancelar",                      "ja":"　いいえ"  },
...
# MAIN MENU
  ...
  0x87C981: { "b":0x87C981, "e":0x87C989, "l":8,  "en":"<<<<Salvar",         "ja":"　休戦　"  },
  0x87C9AE: { "b":0x87C9AE, "e":0x87C9B6, "l":8,  "en":"<<<<Finalizar",      "ja":"　終了　"  },
  # Secret debug item
  0x87C927: { "b":0x87C927, "e":0x87C92F, "l":8,  "en":"_Editar",         "ja":"　ＣＰ　"  },
...
# UNIT COMMANDS
  ...
  # Player commands
  0x87CB76: { "b":0x87CB76, "e":0x87CB7E, "l":8,  "en":"_Aguardar",     "ja":"　待機　"  },
  0x87CB85: { "b":0x87CB85, "e":0x87CB8D, "l":8,  "en":"_Atacar__",     "ja":"　攻撃　"  },
  0x87CB94: { "b":0x87CB94, "e":0x87CB9C, "l":8,  "en":"_Capturar",    "ja":"　占領　"  },
  0x87CBA3: { "b":0x87CBA3, "e":0x87CBAB, "l":8,  "en":"_Embarcar",     "ja":"　搭載　"  },
  0x87CBD0: { "b":0x87CBD0, "e":0x87CBD8, "l":8,  "en":"_Desembarcar",     "ja":"　降車　"  },
  0x87CBB2: { "b":0x87CBB2, "e":0x87CBBA, "l":8,  "en":"_Combinar___",    "ja":"　合流　"  },
  0x87CBC1: { "b":0x87CBC1, "e":0x87CBC9, "l":8,  "en":"_Abastecer__",   "ja":"　補給　"  },
  # Not sure!
  0x87CBDF: { "b":0x87CBDF, "e":0x87CBE7, "l":8,  "en":"_Encounter_",   "ja":"　遭遇　"  },

  # AI(/2P?) commands
  0x868183: { "b":0x868183, "e":0x86818B, "l":8,  "en":"_Aguardar",      "ja":"　待機　"  },
  0x86818D: { "b":0x86818D, "e":0x868195, "l":8,  "en":"_Atacar__",     "ja":"　攻撃　"  },
  0x868197: { "b":0x868197, "e":0x86819F, "l":8,  "en":"_Capturar",    "ja":"　占領　"  },
  0x8681A1: { "b":0x8681A1, "e":0x8681A9, "l":8,  "en":"_Embarcar",     "ja":"　搭載　"  },
  0x8681BF: { "b":0x8681BF, "e":0x8681C7, "l":8,  "en":"_Desembarcar",     "ja":"　降車　"  },
  0x8681AB: { "b":0x8681AB, "e":0x8681B3, "l":8,  "en":"_Combinar___",    "ja":"　合流　"  },
  0x8681B5: { "b":0x8681B5, "e":0x8681BD, "l":8,  "en":"_Abastecer__",   "ja":"　補給　"  },
...
# BATTLE RESULTS / INTEL
  ...
  0x8BB8B5: { "b":0x8BB8B5, "e":0x8BB8BD, "l":8,  "en":"⏫60 Despesas",  "ja":"総軍事費"  },

  # Not sure!
  0x8BB8BF: { "b":0x8BB8BF, "e":0x8BB8C3, "l":4,  "en":"⏫80Batalha",        "ja":"戦闘"  },
  ...
  0x8BA342: { "b":0x8BA342, "e":0x8BA348, "l":6,  "en":"⏫30Unid.",         "ja":"部隊数"  },
  0x8BA360: { "b":0x8BA360, "e":0x8BA368, "l":8,  "en":"⏫60Dias:",          "ja":"全滅日数"  },
...
# NOT SURE / UNUSED?
  ...
  0x858CA0: { "b":0x858CA0, "e":0x858CBE, "l":30, "en":"_Green Earth, batalhar",   "ja":"　グリーンアース軍　戦闘開始　"  },
  0x858CC0: { "b":0x858CC0, "e":0x858CE0, "l":32, "en":"_Yellow Comet, batalhar",  "ja":"　イエローコメット軍　戦闘開始　"  },
  ...
  0x8EF12B: { "b":0x8EF12B, "e":0x8EF139, "l":14, "en":"Teste de som",                   "ja":"サウンドテスト"  },
  0x8EF13B: { "b":0x8EF13B, "e":0x8EF145, "l":10, "en":"Musica_",                       "ja":"おんがく　"  },
  0x8EF147: { "b":0x8EF147, "e":0x8EF155, "l":14, "en":"Efeitos sonoros_⏺81_",                    "ja":"こうかおん１　"  },
  0x8EF157: { "b":0x8EF157, "e":0x8EF165, "l":14, "en":"Efeitos sonoros_⏺82_",                    "ja":"こうかおん２　"  },
  0x8EF167: { "b":0x8EF167, "e":0x8EF175, "l":14, "en":"Efeitos sonoros_⏺83_",                    "ja":"こうかおん３　"  },
  0x8EF1C7: { "b":0x8EF1C7, "e":0x8EF1CB, "l":4,  "en":"Trem_",                       "ja":"嚶勧"  },
  0x8ACE5A: { "b":0x8ACE5A, "e":0x8ACE64, "l":10, "en":"Custo de movimento_",                   "ja":"移動コスト"  },
